...
//                {
//                    if (request.getApprovalCollection() == null) {
//
//
//                    }
//                }
//                request.getApprovalCollection().getApproval().get(1).getApprovalstatus()
//        );
        model.addAttribute("requests",requests);
//        requests.setAttribute("requests", collection.getRequests());
